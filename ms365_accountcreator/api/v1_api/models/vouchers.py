...
class Voucher(MaBaseSchema):
    ...
    user_lifetime = ma.fields.Integer(required=False, allow_none=True, metadata=meta("The lifetime in seconds that users created by this voucher should live. Omit or null for infinite. Takes precendence over user_deletion_date."))
    user_deletion_date = ma.fields.Integer(required=False, allow_none=True, metadata=meta("The date, as unix time, all users created by this voucher are deleted. Omit or null for never. Is overwritten by user_lifetime."))
